...
<body>
    <?php 
        ...
        if(isset($_POST['submit'])){
            ...
            if($nama_bab != ''){
                mysqli_query($koneksi, "INSERT INTO siswa(nama_bab) VALUES('".$nama_bab."') ");                
                   header('location: index-bab.php?id=sukses');                              
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="post-bab.php">
                            
                            <div class="mb-1">
                                <label><strong>Isi disini :</strong></label>
                                <textarea id="mytextarea" name="nama_bab" class="form-control"></textarea><br>
                            </div>
