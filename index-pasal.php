...
<html>
 ...
 <form action="index-pasal.php" method="post">
 ...
 $id = $_GET['id'];
 $query = mysqli_query($koneksi,"SELECT * FROM siswa WHERE pasal LIKE '%".$keyword."%' OR ".$no." LIKE '%".$keyword."%'  ORDER BY id DESC Limit $halaman_awal,$batas");
 ...
 <td class="align-center"><a class="button is-light" href="hapus.php?id=<?php echo $data['id'];?>">hapus</a></td>
